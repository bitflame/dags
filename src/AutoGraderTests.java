...
public class AutoGraderTests {
    ...
    private void testDigraph3() {
        ...
        if (ancestor != 8)
            System.out.printf("The value of ancestor between 7 and 13 should be 8, but it is: %d\n", ancestor);
        shortestDistance = sap.length(7, 13);
        if (shortestDistance != 6)
            System.out.printf("The distance between 7 and 13 should be 6, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(9, 13);
        if (ancestor != 11)
            System.out.printf("The value of ancestor between 9 and 13 should be 11, but it is: %d\n", ancestor);
        shortestDistance = sap.length(9, 13);
        if (shortestDistance != 5)
            System.out.printf("The distance between 9 and 13 should be 5, but it is: %d\n", shortestDistance);
        shortestDistance = sap.length(13, 8);
        if (shortestDistance != 5)
            System.out.printf("The value of length between the nodes 13 and 8 should be 5, but it is: %d\n",
                    shortestDistance);
        ancestor = sap.ancestor(13, 8);
        if (ancestor != 8)
            System.out.printf("The value of ancestor between 13 and 8 should be 8, but it is: %d\n", ancestor);
        shortestDistance = sap.length(8, 13);
        if (shortestDistance != 5)
            System.out.printf("The value of length between the nodes 8 and 13 should be 5, but it is: %d\n",
                    shortestDistance);
        ancestor = sap.ancestor(8, 13);
        if (ancestor != 8)
            System.out.printf("The value of ancestor between 8 and 13 should be 8, but it is: %d\n", ancestor);
        ancestor = sap.ancestor(10, 13);
        if (ancestor != 11)
            System.out.printf("The value of ancestor between 10 and 13 should be 11, but it is: %d\n", ancestor);
        shortestDistance = sap.length(10, 13);
        if (shortestDistance != 4)
            System.out.printf("The distance between 10 and 13 should be 4, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 12);
        if (ancestor != 12)
            System.out.printf("The value of ancestor between 13 and 12 should be 12, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 12);
        if (shortestDistance != 4)
            System.out.printf("The distance between 13 and 12 should be 4, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 11);
        if (ancestor != 11)
            System.out.printf("The value of ancestor between 13 and 11 should be 11, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 11);
        if (shortestDistance != 3)
            System.out.printf("The distance between 13 and 11 should be 3, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 10);
        if (ancestor != 11)
            System.out.printf("The value of ancestor between 13 and 10 should be 11, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 10);
        if (shortestDistance != 4)
            System.out.printf("The distance between 13 and 10 should be 4, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 0);
        if (ancestor != 0)
            System.out.printf("The value of ancestor between 13 and 0 should be 0, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 0);
        if (shortestDistance != 2)
            System.out.printf("The distance between 13 and 0 should be 2, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 14);
        if (ancestor != 14)
            System.out.printf("The value of ancestor between 13 and 14 should be 14, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 14);
        if (shortestDistance != 1)
            System.out.printf("The distance between 13 and 14 should be 1, but it is: %d\n", shortestDistance);
        ancestor = sap.ancestor(13, 9);
        if (ancestor != 11)
            System.out.printf("The value of ancestor between 13 and 9 should be 11, but it is: %d\n", ancestor);
        shortestDistance = sap.length(13, 9);
        if (shortestDistance != 5)
            System.out.printf("The distance between 13 and 9 should be 5, but it is: %d\n", shortestDistance);
        ...
        shortestDistance = sap.length(14, 7);
        if (shortestDistance != 5)
            System.out.printf("The value of length between the nodes 14 and 7 should be 5, but it is: %d\n",
                    shortestDistance);
        ancestor = sap.ancestor(14, 7);
        if (ancestor != 8)
            System.out.printf("The value of ancestor between 14 and 7 should be 8, but it is: %d\n", ancestor);
        shortestDistance = sap.length(7, 14);
        if (shortestDistance != 5)
            System.out.printf("The value of length between the nodes 7 and 14 should be 5, but it is: %d\n",
                    shortestDistance);
        ancestor = sap.ancestor(7, 14);
        if (ancestor != 8)
            System.out.printf("The value of ancestor between 7 and 14 should be 8, but it is: %d\n", ancestor);
    }
    ...
    private void testDigraph9() {
        ...
        if (shortestDistance != 2)
            System.out.printf("The distance between 0 and 1 should be 2, but it is: %d\n", shortestDistance);
        ancestor = sap.length(0, 1);
        if (ancestor != 3) System.out.printf("The ancestor between 0 and 1 should be 3, but it is: %d\n", ancestor);
